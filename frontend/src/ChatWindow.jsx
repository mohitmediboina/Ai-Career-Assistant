...
const ChatWindow = () => {
  ...
  return (
    <div className="flex h-screen overflow-hidden w-full">
      ...
      {/* Sidebar */}
      <div
        className={`fixed md:relative z-50 bg-[#181818] w-[280px] md:w-[320px] h-screen flex flex-col overflow-y-hidden transition-transform duration-300 ${
      ...
      <div className="h-screen flex flex-col bg-[#212121] text-white w-full">
        {/* Header */}
        <header className="p-3 border-b border-stone-700 flex justify-between items-center">
        ...
        <div className="w-full flex mx-auto items-center justify-center mb-4 px-4">
          <footer className="w-full max-w-[750px] flex gap-2">
            <textarea
              className="flex-1 rounded-3xl p-4 text-[16px] bg-[#303030] resize-none max-h-32 text-white outline-none"
            ...
            <button
              ...
              className={`my-auto rounded-xl h-[50px] w-[70px] text-sm transition ${
